<x-app-layout>
    ...
    <div class="row ">
        <div class="col-lg-6 border-lg-end position-relative">
            ...
            {{-- <select class="form-select w-100 border">
                <option value="1"><span>Property <span class="me-2 p-2 border rounded-circle fs-3"><img src="{{ asset('assets/images/company_Logo.png') }}" alt="logo" width="30" srcset=""> Savitara Infotel Pvt Ltd.</span></span></option>
            ...
            <div class="card border mt-3">
                <div class="card-header  d-flex align-items-center justify-content-between bg-transparent">
                    ...
                    <div class="d-flex">
                        <span class="p-1 border rounded me-2"><img src="{{ asset('assets/images/svg/file.svg') }}" alt="file" srcset=""></span>
                        <div class="dropdown">
                ...
                <div class="card-body collapse show pt-0">
                    <input type="text" class="form-control border-0 mb-5" placeholder="Enter your review">
                    <p class="fw-bold fs-4 text-dark">Smart Snippets Used</p>
                    <p class="mb-0">You have not saved any Smart Snippets yet.</p>
                    <a href="#" class="text-secondary">Create first Smart Snippets</a>
                </div>
            </div>
            <div class="text-end">
                ...
                <div class="col-xl-6 col-lg-12 col-md-6 ">
                    <div class="card border">
                        <div class="card-header  d-flex align-items-center justify-content-between bg-transparent">
                            ...
                            <div class="d-flex">
                                <span class="p-2 border rounded "><img
                                        src="{{ asset('assets/images/svg/file.svg') }}" alt="file"
                                        srcset=""></span>
                                <span class="ms-2 p-2 border rounded"><img
                                        src="{{ asset('assets/images/svg/edit.svg') }}" alt="file"
                                        srcset=""></span>
