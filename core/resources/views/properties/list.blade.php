<x-app-layout>
    ...
    @if ($properties->count())
        <div class="row">
            <div class="col-12">
                <a href="{{ route('properties.create') }}" class="btn btn-secondary mb-3 float-end"><i class="far fa-plus"></i> @lang('Add New Property')</a>
            </div>
    ...
    @else
        <div class="col-12 mt-5">
            <div class="text-center">
                ...
                <a href="{{ route('properties.create') }}" class="btn btn-secondary m-2"><i class="far fa-plus"></i> @lang('Add New Property')</a>
            </div>
        </div>
    @endif
</x-app-layout>