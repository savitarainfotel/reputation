                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <x-text-input id="password" class="border-start-0 text-dark" type="password" name="password" placeholder="********" required autocomplete="current-password" />
                                        </div>
                                    ...
                                    <div class="d-flex align-items-end justify-content-end mb-4">
                                        @if (Route::has('password.request'))
                                            <a class="fw-medium fs-3" href="{{ route('password.request') }}">{{ __('Forgot your password?') }}</a>
                                        @endif
                                    </div>

                                    <x-primary-button class="w-100 py-8 mb-4 rounded-2">
                                        {{ __('Log in') }}
                                    </x-primary-button>

                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-medium">@lang('No account yet')?</p>
                                        <a class="text-blue-dark fw-medium ms-2" href="{{ route('register') }}">@lang('Sign up instead')</a>
                                    </div>
                                </form>
