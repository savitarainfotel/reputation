        ...
        <div class="col-3">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <a class="d-block fs-3 text-dark fw-semibold link-primary mb-2" href="javascript:void(0)">{{ $competitor->name }} <i class="fa fa-info-circle text-dark fs-5"></i></a>
                    <p class="text-justify border-bottom pb-3">
                        @lang('Last data collection on ') {{ \Carbon\Carbon::parse($competitor->updated_at)->format('M d, Y') }}
                    </p>
...
@else
    <div class="col-12 mt-5">
        <div class="text-center">
            ...
            <h4 class="mb-4">@lang('No competitors have been added')</h4>
        </div>
    </div>
@endif