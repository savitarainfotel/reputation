                    ...
                    <div class="col-lg-12 mt-2">
                        ...
                        <div class="custom-collapse collapse show" id="collapseSurveyHeader">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input type="text" class="change-title-text" name="title" id="title" :placeholder="__('Your survey name')" :value="__($survey->title)" required />
                            </div>

                            <!-- Description -->
                            <div class="mb-3">
                                <x-input-label class="fw-semibold fs-5" for="description" :value="__('Description')" />
                                <x-text-area class="change-title-text" name="description" id="description" rows="2" :placeholder="__('We hope you enjoyed your stay')" :value="__($survey->description)" required />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <x-text-input type="text" id="selected-color" name="selected_color" data-position="bottom right" value="{{$survey->selected_color}}" readonly required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="custom-collapse collapse show" id="collapseQuestionRatingScale">
                            <div>
                                ...
                                <select class="form-control form-select" id="rating-scale" required name="rating_scale">
                                    <option value="{{ $status::NPS }} " @if($survey->rating_scale == $status::NPS) selected @endif>@lang('NPS (0-10)')</option>
                                    <option value="{{ $status::STAR }}" @if($survey->rating_scale == $status::STAR) selected @endif>@lang('Star (1 - 5)')</option>
                                </select>
                            </div>
                            <div class="mt-3 question-list">
                                @foreach ($survey->questions as $index => $question)
                                    <div class="mt-3">
                                        <x-input-label class="fw-semibold fs-5" for="question-{{ $index + 1 }}" :value="__('Question ' . ($index + 1))" /> <i class="fas fa-info-circle ms-2 fa-lg"></i>
                                        <x-text-input name="questions[]" id="question-{{ $index + 1 }}" :value="$question->question" :placeholder="__('How would you rate your overall experience with us?')" required />
                                    </div>
                                @endforeach                                
                            ...
                            <div>
                                ...
                                <x-text-area class="change-title-text" id="comment" name="comment" rows="1" placeholder="comment" :value="__($survey->comment)" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 mt-2">
